...
def interpolate_encoder_values(encoder_timestamps, encoder_1_ticks, encoder_2_ticks, rel_enc_ticks_to_rad, brake_timestamps, enable_smoothing):
...
def compute_k(torque_table,
    ...
    encoder_interp_delta, encoder_delta = interpolate_encoder_values(encoder_timestamps, encoder_1_ticks, encoder_2_ticks, rel_enc_ticks_to_rad, brake_timestamps, enable_smoothing)
